...
export default function Section1 () {
    return (
        <Box sx={{margin: '12em 2em 0 2em', display: 'flex', justifyContent: 'center', flexWrap: 'wrap', paddingBottom: '2em'}}>
            <Box sx={{padding: '0 3em', maxWidth: '600px'}}>
                <Typography variant="h1" color="#97DFFC" fontFamily= "Andika, sans-serif" fontWeight={700} fontSize="128px">Yael <span style={{display: 'block'}}>Correa</span></Typography>
            ...
            <Box sx={{padding: '0 2em', maxWidth: '600px'}}>
